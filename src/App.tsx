...
import { PopoverThread, theme } from "@collabkit/pro-theme-cashboard";
...
const Cell = ({ value, row, column }: CellProps) => {
  ...
  const { threadVisible, previewVisible, showThread, hasThread } =
    usePopoverThread({
      objectId: cellId,
      objectName: name,
    });
...
export default function App() {
  ...
  return (
    <CollabKitProvider
      colorScheme="light"
      apiKey={"hvqs9xg20e_7fGRDd4UzW"}
      appId={"69a1L9o1JFLuIJyZ1d0S9"}
